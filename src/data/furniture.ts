...
export const furnitureCatalog: FurnitureTemplate[] = [
  ...
  {
    id: 'ikea-friheten-expanded',
    name: 'IKEA FRIHETEN (expanded)',
    category: 'Living Room',
    icon: '🛋️',
    color: '#94a3b8',
    widthInches: 89,
  ...
  {
    id: 'murphy-bed-single',
    name: 'Murphy Bed - Single',
    category: 'Bedroom',
    icon: '🛏️',
    color: '#e2e8f0',
    widthInches: 80,
  ...
  {
    id: 'murphy-bed-single-expanded',
    name: 'Murphy Bed - Single (expanded)',
    category: 'Bedroom',
    icon: '🛏️',
    color: '#e2e8f0',
    widthInches: 80,
